...
class Signup(SeleniumWrapper):
    ...
    def sel_gender_male(self,Gender):
        self.select_item(self._select_gender, item=Gender)

    def sel_gender_female(self,Gender):
        self.select_item(self._select_gender, item=Gender)

    def reg_enter_name(self,Name):
        self.enter_element(self._txt_name, value=Name)

    def reg_select_pro(self):
        self.click_element(self._rdo_pro)

    def reg_select_bus(self):
        self.click_element(self._rdo_bus)

    def sel_country(self,Your_country):
        self.select_item(self._select_country,item=Your_country)

    def reg_enter_phone(self,phone):
        self.enter_element(self._txt_phone, value=phone)
    ...
    def reg_enter_conpass(self,conpass):
        self.enter_element(self._txt_conpass, value=conpass)

    def chk_box(self):
        self.click_element(self._chk_box)

    def reg_btn(self):
        self.click_element(self._reg_btn)